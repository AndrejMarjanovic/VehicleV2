namespace Vehicle.FormUI.Forms
{
    partial class frmSeats
    {
        ...
        private void InitializeComponent()
        {
            ...
            SeatCombo = new DataGridViewTextBoxColumn();
            ...
            dgvSeats.AllowUserToOrderColumns = true;
            ...
            dgvSeats.Columns.AddRange(new DataGridViewColumn[] { dataGridViewTextBoxColumn1, type, SeatCombo, EditModel, Delete });
            ...
            dgvSeats.DefaultCellStyle = dataGridViewCellStyle3;
            dgvSeats.Location = new Point(12, 59);
            dgvSeats.Name = "dgvSeats";
            dgvSeats.ReadOnly = true;
            dgvSeats.RowTemplate.Height = 25;
            dgvSeats.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
            dgvSeats.Size = new Size(776, 259);
            dgvSeats.TabIndex = 0;
            dgvSeats.CellContentClick += dgvSeats_CellContentClick;
            dgvSeats.ColumnHeaderMouseClick += dgvSeats_ColumnHeaderMouseClick;
            // 
            ...
            type.DataPropertyName = "numberOfSeats";
            type.HeaderText = "Number";
            type.Name = "type";
            type.ReadOnly = true;
            // 
            // SeatCombo
            // 
            SeatCombo.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill;
            SeatCombo.DataPropertyName = "SeatTypeColour";
            SeatCombo.HeaderText = "Material and colour";
            SeatCombo.Name = "SeatCombo";
            SeatCombo.ReadOnly = true;
            // 
            // EditModel
            // 
        ...
        private DataGridViewTextBoxColumn SeatCombo;
